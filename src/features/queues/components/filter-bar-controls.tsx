    ...
    <div className="relative w-[128px] shrink-0">
      ...
      <details>
        ...
        >
          ...
          <span aria-hidden="true" className="ml-2 text-[10px] text-[#7b8794]">
            ▾
          </span>
        </summary>
        <div className="absolute top-full left-0 z-20 mt-1 min-w-[12rem] rounded-md border border-[#d5dde5] bg-white py-1 shadow-[0_12px_28px_rgba(15,40,70,0.12)]">
          {organizations.length === 0 ? (
            <p className="px-3 py-2 text-xs text-[#7b8794]">No organizations</p>
          ) : (
            organizations.map((organization) => (
              ...
              >
                <input
                  ...
                  name="organization"
                  value={organization}
                  defaultChecked={picked.includes(organization)}
