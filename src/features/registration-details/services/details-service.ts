...
function mergeDetails(
  ...
  return {
    ...
    phone: display(base.phone, extras.phone),
    mobile: display(base.mobile, extras.mobile),
    address: display(base.address, extras.address),
    nationality: display(base.nationality, extras.nationality),
    ipAddress: display(base.ipAddress, extras.ipAddress),
